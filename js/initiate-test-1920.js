...
function init_myChart2() {
	...
	option = {
		...
		xAxis: [{
			...
			data: ['1月', '2月', '3月', '4月', '5月', '6月', '7月', '8月', '9'],
			offset: 10
		}],
		yAxis: [{
			type: 'value',
...
function init_myChart6(){
	var data = {"uploadData":[{"count":5421,"areaName":"公共"},{"count":6512,"areaName":"健康保障"},{"count":3721,"areaName":"安全生产"},{"count":2842,"areaName":"价格监督"}
...
var xData = ['公共服务','健康保障','安全生产','价格监督','能源安全','信用', '城乡建设', '社区治理', '生态环保','应急维稳'];
